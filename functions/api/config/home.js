/**
 * Greybox API (Cloudflare): GET /api/config/home
 * Homepage structure from D1 (Greybox-owned only — no TMDB data here).
 * Short cache on purpose: homepage edits in D1 should show up within ~a minute.
 */
import { getDb, readHomeConfig } from '../../lib/db.js';
...
export async function onRequest(context) {
  try {
    ...
    return json(await readHomeConfig(db), 200);
  } catch (e) {
